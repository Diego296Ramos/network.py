...
class Network(object):
    ...
    def SGD(self, training_data, epochs, mini_batch_size, eta,
        ...
        for j in range(epochs):
            ...
            ## Se definen los minibatches al dividir los datos
            mini_batches = [
    ...
    def evaluate(self, test_data):
        ...
        ## Repitiendo lo que se explica arriba, se comparan las salidas predichas con las salidas reales y contar las correctas
